...
/* Altitude do celular → as duas altitudes (18/09/2026, pedido dela).
   H (ortométrica, "cota") = h (elipsoidal) − N. No campus N ≈ −5,56 m (relatório RTK de 21/01/2023, −5,557 m).
   O navegador não diz qual altitude entrega. Pelos dados do campus: Android dá a elipsoidal (mediana 6,3 m)
   e iPhone já dá a ortométrica (mediana 11,7 m) — diferença ≈ N. Conferir com a cota do M0452. */
