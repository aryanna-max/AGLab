/* Cardápio sugerido de missões — ponto de partida que a professora importa, edita e amplia.
   ...
   equipe: true → a professora forma as equipes ao lançar. Não há funções definidas dentro da equipe. */
...
export const CARDAPIO_SUGERIDO = [
  ...
  {
    frente: 'planimetria', titulo: 'Cadastro de rede · caso BRK Ambiental', equipe: true,
  ...
  {
    frente: 'planimetria', titulo: 'Trena contra celular', equipe: true,
  ...
  {
    frente: 'altimetria', titulo: 'Caderneta de nivelamento', equipe: true,
  ...
  {
    frente: 'altimetria', titulo: 'Transporte de RN', equipe: true,
  ...
  {
    frente: 'altimetria', titulo: 'Rampa acessível', equipe: true,
  ...
  {
    frente: 'planialtimetria', titulo: 'Celular contra RTK', equipe: true,
